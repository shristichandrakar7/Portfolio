...
export const experiences = [
  {
    ...
    desc: "Designed, developed, and optimized database objects such as tables, views, stored procedures, triggers, and functions using PL/SQL increasing data processing speed by 50% and reducing overall system downtime by 25%.Optimized SQL queries by implementing indexing, query rewriting, and other advanced techniques resulting in a 40% reduction in average query execution time and improved database performance.",
    skills: [
      "Oracle",
      "SQL",
      "PL/SQL",
...
export const projects = [
  ...
  },
  {
    ...
    image:
      "	https://social-media-app-snapgram.vercel.app/assets/images/side-img.svg",
    tags: [
      "TypeScript", "React JS", "React Query", "Tailwind CSS", "Appwrite"
    ],
    category: "web app",
